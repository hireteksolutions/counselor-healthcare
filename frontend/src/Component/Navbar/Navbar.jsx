    ...
    return (
        <div className={styles.navbar}>
            ...
            <ul className={styles.navLinks}>
                ...
                <li className={styles.navLink} onClick={() => navigate('/we-help-with')}>

                    We Help With

                    <ul className={styles.subMenu}>

                        <li onClick={() => navigate('/relationship-counselling')}>
                ...
                <li className={styles.navLink} onClick={() => navigate('/counsellors')}>
                    Counsellors
                </li>
                ...
                <li className={styles.navLink} onClick={() => navigate('/get-started')}>Get Started</li>
                <li className={styles.navLink} onClick={() => navigate('/sign-in')}>Sign In</li>
            </ul>
        </div>
    );
}
